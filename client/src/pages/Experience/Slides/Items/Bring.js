...
import { BringText as text } from '../SlidesText';
...
const Bring = ({ toBring, submitInput, lang }) => {
    ...
    return (
        <div onKeyDown={handleEnter}>
            <div>
                ...
                <p className={classes.description}>{text.question1[lang]}</p>
            ...
            {showForm &&
                <>
                    <div>
                        <p className={classes.description}>{text.question2[lang]}</p>
